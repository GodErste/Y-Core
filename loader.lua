...
local function fail(message)
	if LoadingPresentation then pcall(LoadingPresentation.Complete, LoadingPresentation, false) end
...
if LoadingPresentation then
    ...
    pcall(LoadingPresentation.Complete, LoadingPresentation, Outcome)
end
